...
use traverse_core::{KeyResolver, LayoutInfo, StaticKeyPath, Key, TraverseError};
...
impl CosmosKeyResolver {
    ...
    fn find_storage_entry<'a>(
        ...
        layout
            ...
            .ok_or_else(|| TraverseError::InvalidQuery(format!("Storage entry not found: {}", name)))
    }
        ...
        match parsed_query {
            CosmWasmQuery::Item { name } => {
                ...
                Ok(StaticKeyPath {
                    ...
                    field_size: Some(
                        type_info.number_of_bytes.parse::<u8>()
            ...
            CosmWasmQuery::NestedField { base, field: _field } => {
