...
use alloc::vec::Vec;
use crate::{TraverseError, LayoutInfo, StaticKeyPath, CoprocessorQueryPayload};
...
/// `CoprocessorQueryPayload` structs directly.
/// 
/// # Examples
/// 
/// ```rust,ignore
...
pub trait ProofFetcher {
    ...
    /// # Returns
    /// 
    /// * `Ok(CoprocessorQueryPayload)` - Successfully fetched proof
    ...
    /// // Submit payload to ZK coprocessor
    /// ```
    fn fetch(&self, key: &[u8; 32]) -> Result<CoprocessorQueryPayload, TraverseError>;
} 